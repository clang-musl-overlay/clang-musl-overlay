...
SRC_URI="mirror://sourceforge/sbcl/${P}-source.tar.bz2
	amd64? ( !system-bootstrap? ( https://github.com/roswell/sbcl_bin/releases/download/${BV_AMD64}/${PN}-${BV_AMD64}-x86-64-linux-musl-binary.tar.bz2 ) )
"
...
src_compile() {
	if use system-bootstrap; then
		...
		local SBCL_EXE="sh ${WORKDIR}/sbcl-binary/run-sbcl.sh"
	fi
