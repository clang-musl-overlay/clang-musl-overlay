...
PATCHES=(
	...
	# We (clang-musl-overlay) weren't able to reproduce
	# https://bugs.gentoo.org/870919, at least on our x86_64 machines.
	# Dropping -latomic from the build process again.
