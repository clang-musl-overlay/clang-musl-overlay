...
if [[ ${PV} == 9999 ]]; then
	EGIT_REPO_URI="https://github.com/dacyberduck/binutils-config.git"
	inherit git-r3
else
	SRC_URI="https://github.com/dacyberduck/binutils-config/archive/refs/tags/v${PV}.tar.gz"
...
pkg_postinst() {
	...
	einfo "If you want to use llvm binutils, remember to run 'binutils-config llvm-latest'"
}
